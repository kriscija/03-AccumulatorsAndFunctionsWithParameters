...
def run_test_sum_of_digits():
    ...
    # test 3
    expected3 = 11
    answer3 = sum_of_digits(371)
    print('Test 3 expected:', expected3)
    print('       actual:', answer3)

    # test 4
    expected4 = 6
    answer4 = sum_of_digits(111111)
